...
<!-- Content Block -->
<div class="f_nbs" align="left" style="font-size:medium;font-weight:normal;color:black;background-color:unset;">　
...
<div class="f_nps" align="left" style="font-size:medium;font-weight:normal;color:black;background-color:unset;">
...
# Korean Fonts
.f_nps{font-family: 'Nanum Pen Script', cursive;}
.f_jg{font-family: 'Jeju Gothic', sans-serif;}
.f_jm{font-family: 'Jeju Myeongjo', serif;}
.f_kb{font-family: 'KoPub Batang', serif;}
.f_nbs{font-family: 'Nanum Brush Script', cursive;}
.f_nsk{font-family: 'Noto Sans KR', sans-serif;}
.f_h{font-family: 'Hanna', sans-serif;}
.f_ng{font-family: 'Nanum Gothic', sans-serif;}
.f_nm{font-family: 'Nanum Myeongjo', serif;}
.f_jh{font-family: 'Jeju Hallasan', cursive;}
.f_ngc{font-family: 'Nanum Gothic Coding', monospace;}
Notice -->
