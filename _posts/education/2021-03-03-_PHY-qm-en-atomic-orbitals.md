...
<div align="center" class="top_btn_box">
  ...
  <button class="top_btn" type="button" style="background-color:blue;" onclick="location.href='#'">C</button>
  <button class="top_btn" type="button" style="background-color:blue;" onclick="location.href='#'">C</button>
</div><br>
<!-- Top Block -->
...
<div align="center" class="bottom_btn_box">
  <span class="bottom_btn"><a href="https://github.com/ailever/ailever.github.io/blob/master/_posts/education/2021-03-03-_PHY-qm-en-atomic-orbitals.md" target="_blank" style="color:white">Edit</a></span>
</div>
<!-- Bottom Block -->
