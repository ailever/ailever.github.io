...
- (/2020) Predicting commercially available antiviral drugs that may act on the novel coronavirus (SARS-CoV-2) through a drug-target interaction deep learning model
<span style="font-size:small;">
  :[url]()
  :[review]()
</span>
...
- (/2020) Wx: a neural network-based feature selection algorithm for next-generation sequencing data
<span style="font-size:small;">
  :[url]()
  :[review]()
</span>
- (/2020) Cascaded Wx: a novel prognosis-related feature selection framework in human lung adenocarcinoma transcriptomes
<span style="font-size:small;">
  :[url]()
  :[review]()
</span>
